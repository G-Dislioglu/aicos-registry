...
const productText = {
  de: {
    ...
    chat: {
      ...
      threadCompass: 'Fadenkompass',
      threadCompassEmpty: 'Noch kein Digest vorhanden. Verdichte den Faden, wenn du eine kompakte Orientierung willst.',
      threadCompassSummary: 'Faden-Kern',
      threadCompassCurrentState: 'Aktueller Stand',
      threadCompassOpenLoops: 'Offene Punkte',
      threadCompassNextEntry: 'Nächster Einstieg',
      threadCompassConfidence: 'Vertrauen',
      threadCompassUpdatedAt: 'Aktualisiert',
      threadCompassRefresh: 'Faden verdichten',
      threadCompassNeedsRefresh: 'Seit dem letzten Digest sind neue Nachrichten dazugekommen.',
  ...
  en: {
    ...
    chat: {
      ...
      selectSession: 'Open',
      threadCompass: 'Thread compass',
      threadCompassEmpty: 'No digest yet. Condense the thread when you want a compact orientation layer.',
      threadCompassSummary: 'Thread core',
      threadCompassCurrentState: 'Current state',
      threadCompassOpenLoops: 'Open loops',
      threadCompassNextEntry: 'Next entry',
      threadCompassConfidence: 'Confidence',
      threadCompassUpdatedAt: 'Updated',
      threadCompassRefresh: 'Condense thread',
      threadCompassNeedsRefresh: 'New messages arrived since the last digest.',
