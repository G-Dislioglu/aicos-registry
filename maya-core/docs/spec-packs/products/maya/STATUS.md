...
- nächster Umbauauftrag: kleiner Guardrail-Signal-Stability-Review-Block zur Prüfung, ob `mirror`, `overclaimWarning` und `freshnessWarning` nach der bisherigen Kalibrierung in echten oder nah-simulierten Läufen zu oft stumm oder zu oft laut bleiben
