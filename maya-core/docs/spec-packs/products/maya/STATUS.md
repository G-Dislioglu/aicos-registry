...
- nächster Umbauauftrag: kleiner `Pre-Dispatch Crush Light Review Closure`-Block zur Prüfung, ob die Fokusmarkierung der letzten User-Nachricht in echten oder nah-simulierten Läufen weiter sauber priorisiert, ohne ältere Breitenpfade oder Guardrail-Nachspur unbeabsichtigt zu übersteuern
