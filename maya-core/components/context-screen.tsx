      ...
      <div className="flex flex-col gap-4">
        <section className="rounded-[28px] border border-violet-400/20 bg-violet-500/10 p-4 shadow-shell sm:p-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="text-xs uppercase tracking-[0.22em] text-violet-200">{text.context.primaryWorkspace}</div>
              <p className="mt-2 text-sm leading-6 text-slate-200">{text.context.primaryWorkspaceBody}</p>
            </div>
            <Link
              href="/maya"
