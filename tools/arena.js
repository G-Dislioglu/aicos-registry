...
function formatMecCandidates(items) {
 ...
 function formatMecReviewWorkspace(items) {
  ...
  return items.map(item => `${item.workspace_id} | ${item.candidate_type} | review:${item.current_review_state} | latest:${item.latest_review_outcome || '-'} | reviews:${item.review_summary ? item.review_summary.review_count : 0} | reviewable:${item.reviewable} | terminal:${item.terminal} | unresolved:${item.unresolved_runtime_reference_count || 0} | freshness:${item.freshness_state || '-'} | refutation:${item.workspace_summary && item.workspace_summary.refutation_role ? item.workspace_summary.refutation_role : 'not_applicable'} | visible-refutations:${item.workspace_summary && item.workspace_summary.visible_refutation_count !== undefined ? item.workspace_summary.visible_refutation_count : 0} | dossier:${item.workspace_summary && item.workspace_summary.challenge_dossier_role ? item.workspace_summary.challenge_dossier_role : 'not_applicable'} | posture:${item.workspace_summary && item.workspace_summary.challenge_posture_bucket ? item.workspace_summary.challenge_posture_bucket : 'not_visible'} | lines:${item.workspace_summary && item.workspace_summary.challenge_line_count !== undefined ? item.workspace_summary.challenge_line_count : 0} | delta-movement:${item.workspace_summary && item.workspace_summary.challenge_dossier_delta_movement ? item.workspace_summary.challenge_dossier_delta_movement : 'not_derivable'} | new-lines:${item.workspace_summary && item.workspace_summary.challenge_dossier_new_lines !== undefined ? item.workspace_summary.challenge_dossier_new_lines : 0} | digest:${item.workspace_summary && item.workspace_summary.challenge_dossier_review_digest_bucket ? item.workspace_summary.challenge_dossier_review_digest_bucket : 'not_applicable'} | watchpoints:${item.workspace_summary && item.workspace_summary.challenge_dossier_review_watchpoints !== undefined ? item.workspace_summary.challenge_dossier_review_watchpoints : 0} | gate:${item.workspace_summary && item.workspace_summary.review_gate_readiness_bucket ? item.workspace_summary.review_gate_readiness_bucket : 'gate_not_ready'} | coverage-signal:${item.workspace_summary && item.workspace_summary.review_gate_coverage_signal ? item.workspace_summary.review_gate_coverage_signal : 'not_visible'} | watchpoint-signal:${item.workspace_summary && item.workspace_summary.review_gate_watchpoint_signal ? item.workspace_summary.review_gate_watchpoint_signal : 'not_visible'} | reason-codes:${item.workspace_summary && item.workspace_summary.review_gate_reason_code_count !== undefined ? item.workspace_summary.review_gate_reason_code_count : 0} | primary-reason:${item.workspace_summary && item.workspace_summary.review_gate_primary_reason_code ? item.workspace_summary.review_gate_primary_reason_code : 'not_visible'} | decision-risk:${item.workspace_summary && item.workspace_summary.review_gate_decision_risk_bucket ? item.workspace_summary.review_gate_decision_risk_bucket : 'not_visible'} | open-points:${item.workspace_summary && item.workspace_summary.review_gate_decision_open_point_count !== undefined ? item.workspace_summary.review_gate_decision_open_point_count : 0} | action-posture:${item.workspace_summary && item.workspace_summary.review_action_posture_bucket ? item.workspace_summary.review_action_posture_bucket : 'not_visible'} | allowed-actions:${item.workspace_summary && item.workspace_summary.review_action_allowed_count !== undefined ? item.workspace_summary.review_action_allowed_count : 0} | blocked-actions:${item.workspace_summary && item.workspace_summary.review_action_blocked_count !== undefined ? item.workspace_summary.review_action_blocked_count : 0} | holds:${item.workspace_summary && item.workspace_summary.review_action_hold_count !== undefined ? item.workspace_summary.review_action_hold_count : 0} | escalations:${item.workspace_summary && item.workspace_summary.review_action_escalation_count !== undefined ? item.workspace_summary.review_action_escalation_count : 0} | obligations:${item.workspace_summary && item.workspace_summary.review_action_obligation_count !== undefined ? item.workspace_summary.review_action_obligation_count : 0} | obligation-gaps:${item.workspace_summary && item.workspace_summary.review_action_gap_count !== undefined ? item.workspace_summary.review_action_gap_count : 0} | attention-points:${item.workspace_summary && item.workspace_summary.review_action_attention_count !== undefined ? item.workspace_summary.review_action_attention_count : 0} | defer-reasons:${item.workspace_summary && item.workspace_summary.review_action_defer_count !== undefined ? item.workspace_summary.review_action_defer_count : 0} | controls:${item.control_readiness && item.control_readiness.available_outcomes ? item.control_readiness.available_outcomes.join(',') || '-' : '-'} | ${item.title}`).join('\n');
 }
